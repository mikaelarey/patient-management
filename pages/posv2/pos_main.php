                        ...
                        <div class="box-header">
                            ...
                            if (isset($_POST['category'])) {
                                ...
                                if ($selectedCategoryId == '*') {
                                    // Lahat ng kategorya
                                    $productsQuery = mysqli_query($con, "SELECT id, name, price, description, image FROM tblproduct WHERE status='ACTIVE'");
                                } else {
                                    // Isang kategorya lamang
                                    $productsQuery = mysqli_query($con, "SELECT id, name, price, description, image FROM tblproduct WHERE cat_id = $selectedCategoryId AND status='ACTIVE'");
                                }
                                ...
                                while ($row = mysqli_fetch_array($productsQuery)) {
                                    ...
                                    echo '<img class="card-img-top" src="../../assets/img/' . $row['image'] . '" alt="Card image" style="max-width: 100px; max-height: 100px;">';

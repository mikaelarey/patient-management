                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Status:</label>
                                <input name="txt_edit_status" class="form-control input-sm" type="text" value="'.$row['pstatus'].'" readonly/>
                            </div>
                            <div class="form-group">
                                <label>Description:</label>
                                <textarea name="txt_edit_description" class="form-control input-sm" readonly>'.$row['description'].'</textarea> 
                            </div>
                            <label>Image:</label>
                            <div class="form-group">
                                <image src="../../assets/img/'.basename($row['image']).'" style="width:200px;height:200px;"/>
                            </div>
                        </div>
                    </div>
                </div>

                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select name="txt_type" class="form-control input-sm select2" style="width:100%">
                                        ...
                                        <?php
                                            ...
                                            while($rowc = mysqli_fetch_array($qc)){
                                                echo '
                                                <option value="'.$rowc['id'].'">'.$rowc['category'].'</option>
                                                ';
                                            }
                                        ?>   
                                    </select>
                                ...
                                <div class="form-group">
                                    <label>Name:</label>
                                    <input name="txt_name" class="form-control input-sm" type="text" placeholder="Products"/>
                                </div>
                                <div class="form-group">
                                    <label>Price:</label>
                                    <input name="txt_price" class="form-control input-sm" type="text" placeholder="Price"/>
                                </div>
                                
                                <div class="form-group">
                                    <label>Quantity:</label>
                                    <input name="txt_quantity" class="form-control input-sm" type="text" placeholder="Quantity"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_description" class="form-control input-sm" type="text" placeholder="Description"/>
                                </div>
